    ...
    while t < Max_iter:
        for i in range(0, SearchAgents_no):
            ...
            if fitness > Leader_score:  # Change this to > for maximization problem
                ...
                # Adicione as seguintes linhas para arredondar as posições do líder
                Leader_pos = Leader_pos / numpy.sum(Leader_pos) #Normalize
                Leader_pos = numpy.round(Leader_pos, 1)
            ...
            for j in range(0, dim):
                ...
                if p < 0.5:
                    if abs(A) >= 1:
                        ...
                        # Adicione as seguintes linhas para arredondar as posições dos agentes de busca
                        decimal_places = 5  # Defina o número de casas decimais desejado
                        Positions[i, j] = round(Positions[i, j], decimal_places)
        ...
        if t % 1 == 0:
            ...
            print(["Best solution is " + str(Leader_pos)])
        t = t + 1
